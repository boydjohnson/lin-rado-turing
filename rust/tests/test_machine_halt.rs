...
const HALTS: &[(&str, usize, usize, &str)] = &[
    ...
    // Lynn (1971)
    (
        "1RB 1RA  1LC 0LD  0RA 1LB  1RH 0LE  1RC 1RB",
        15,
        435,
        "5-2",
    ),
    (
        "1RB 1RC  1LC 1LD  0RA 1LB  1RE 0LB  1RH 1RD",
        22,
        292,
        "5-2",
    ),
    (
        "1RB 0RC  1LC 0LB  1RD 1LB  1RE 0RA  0RB 1RH",
        22,
        217,
        "5-2",
    ),
...
fn assert_machine<S: State + Send + Sync + ToString, Sym: Symbol + Send + Sync + ToString>(
    ...
    let mut machine = Machine::<_, _, SSTape<_>>::new(prog);
